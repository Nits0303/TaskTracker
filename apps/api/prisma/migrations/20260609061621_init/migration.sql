...
-- CreateEnum
CREATE TYPE "ProjectStatus" AS ENUM ('Active', 'OnHold', 'Completed');

-- CreateEnum
CREATE TYPE "ActivityEventType" AS ENUM ('TaskCreated', 'TaskUpdated', 'StatusChanged', 'TaskCompleted', 'CommentAdded', 'AttachmentAdded', 'MemberJoined', 'MemberRemoved', 'MeetingRequested', 'MeetingAccepted', 'MeetingDeclined');
...
-- CreateIndex
CREATE UNIQUE INDEX "MeetingParticipant_meetingRequestId_userId_key" ON "MeetingParticipant"("meetingRequestId", "userId");
...
-- AddForeignKey
ALTER TABLE "MeetingRequest" ADD CONSTRAINT "MeetingRequest_workspaceId_fkey" FOREIGN KEY ("workspaceId") REFERENCES "Workspace"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "MeetingParticipant" ADD CONSTRAINT "MeetingParticipant_meetingRequestId_fkey" FOREIGN KEY ("meetingRequestId") REFERENCES "MeetingRequest"("id") ON DELETE CASCADE ON UPDATE CASCADE;

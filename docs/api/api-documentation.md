...
### POST /workspaces/:slug/projects/:projectId/calendar/blocks
**Description:** Create a personal calendar block
**Auth required:** Yes
**Rate limit:** Standard limits apply
...
### PATCH /workspaces/:slug/projects/:projectId/calendar/blocks/:blockId
**Description:** Update a personal calendar block
**Auth required:** Yes
**Rate limit:** Standard limits apply
...
### DELETE /workspaces/:slug/projects/:projectId/calendar/blocks/:blockId
**Description:** Delete a personal calendar block
**Auth required:** Yes
**Rate limit:** Standard limits apply
...
### POST /workspaces/:slug/projects/:projectId/meetings/check-conflicts
**Description:** Check scheduling conflicts for participants
**Auth required:** Yes
**Rate limit:** Custom rate limit
...
**Description:** Respond to a meeting request
**Auth required:** Yes
**Rate limit:** Standard limits apply
...
### PATCH /workspaces/:slug/projects/:projectId/meetings/:meetingId
**Description:** Update a meeting time
**Auth required:** Yes
**Rate limit:** Standard limits apply
...
| boolean | boolean | No | In-app notifications when a member joins |
